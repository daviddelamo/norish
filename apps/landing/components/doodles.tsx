 ...
 * step arrives (`.doodle-line` in globals.css), staggered so the drawing
  ...
  return (
    <svg aria-hidden className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g {...stroke}>
        ...
        />
        <path className="doodle-line" d="M12 3.5v5.75M9.6 7l2.4 2.4L14.4 7" style={order(1)} />
      </g>
    </svg>
  );
}
  ...
  return (
    <svg aria-hidden className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g {...stroke}>
        ...
        />
        <path className="doodle-line" d="M8.75 4.5v3.5M15.25 4.5v3.5" style={order(1)} />
        <path className="doodle-line" d="M4.5 11.25h15" style={order(2)} />
      </g>
  ...
  return (
    <svg aria-hidden className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g {...stroke}>
        ...
        />
        <path className="doodle-line" d="M17.75 14.5h2.75" style={order(1)} />
