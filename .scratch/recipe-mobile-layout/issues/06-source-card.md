...
- [ ] The card shows the source host and opens the original in a new tab with `rel="noopener noreferrer"`
- [ ] A recipe with no URL renders no card
- [ ] The title carries no source icon
- [ ] The card renders on share-mobile
